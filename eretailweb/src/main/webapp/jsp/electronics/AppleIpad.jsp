		...
		<div class="row details_row">
			...
			<div class="col-lg-6">
				<div class="details_image">
					<div class="details_image_large">
						<img src="/eretailweb/static/images/product_6.jpg" alt="">
			...
			<div class="col-lg-6">
				<div class="details_content">
					<div class="details_name">Apple iPad(6th Gen) Tablet (9.7
						inch, 32GB, Wi-Fi), Space Grey</div>
					...
					<div class="details_text">
						<p>8MP primary camera with auto focus, flash, panorama</p>
						<p>2GB RAM and 32GB internal memory</p>
						<p>Upto 10 hrs battery life on a single charge,3500mAH
							lithium-polymer battery</p>
						<p>iOS v11 operating system with 2.34GHz A10 Fusion chip with
							64-bit architecture Embedded M10 quad core processor, 2GB RAM and
							32GB internal memory</p>

						<div class="details_share">

							<P>
							<li>buy Apple Pencil separately. iPad supports Apple Pencil
								. Doesn’t come in the box</li>
							</P>
							<P>
							...
							<P>
							<li>manufacturer warranty for device and 6 months
