		...
		<div class="row details_row">
			...
			<div class="col-lg-6">
				<div class="details_image">
					<div class="details_image_large">
						<img src="/eretailweb/static/images/product_9.jpg" alt="">
			...
			<div class="col-lg-6">
				<div class="details_content">
					<div class="details_name">Canon EOS 1300D 18MP Digital SLR
						Camera (Black) with 18-55mm ISII Lens, 16GB Card and Carry Case</div>
					...
					<div class="details_text">
						<p>Weight : 743 Grams</p>
						<p>Height : 50 Meters</p>
						<p>Camera : Yes</p>
