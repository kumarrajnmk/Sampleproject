...
@media (max-width: 800px) {
  ...
  .col-25 {
	...
	<div class="container">
					...
					<div class="contact_form_container">
						<form action="#" id="payment_form" class="contact_form">
							<div class="row">
								<div class="col-xl-6">
									<!-- Name -->
									<label for="contact_name"><font color=black size=4>Name on card*</font></label> <input
							...
							<div class="row">
								<div class="col-xl-6">
									<!-- Name -->
									<label for="emailAddress"><font color=black size=4>Card Number*</font></label> <input
							...
							<div class="row">
							    <div class="col-xl-6">
									<!-- Name -->
									<label for="emailAddress"><font color=black size=4>Expiration Date*</font></label><!--  <input
										type="text" id="emailAddress" class="contact_input"
										required="required"> -->
								</div>
							</div>
		<div class="row">&nbsp;&nbsp;&nbsp;
            <div class="col-xs-6">
              <select class="form-control col-sm-10" name="expiry-month" id="expiry-month">
               <option>Month</option>
          ...
          <div class="row">
				<div class="col-xl-3">
					<!-- Name -->
				  <label for="contact_name"><font color=black size=4>Card CVV*</font></label> 
					<input type="text" id="contact_name" class="contact_input" required="required">
				</div>
				
					<!-- <a href="/eretailweb/placeorder1.do">Continue</a> -->
					<div class="button order_button"><a href="/eretailweb/placeorder1.do?id=${1}">Continue</a></div>
 		 					</div>
						</form>
					</div>
				</div>
