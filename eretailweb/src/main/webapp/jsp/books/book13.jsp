		...
		<div class="row details_row">
			...
			<div class="col-lg-6">
				<div class="details_image">
					<div class="details_image_large">
						<img src="/eretailweb/static/images/americanhistory.jpg" alt="">
			...
			<div class="col-lg-6">
				<div class="details_content">
					<div class="details_name">American History Comic Books:
						Twelve Reproducible Comic Books With Activities Guaranteed to Get
						Kids Excited About Key Events and People in American History
						(Funnybone Books)</div>
					...
					<div class="details_text">
						<p>In this collection of engaging and entertaining mini-comic
							books, students share in the adventures of time traveler Scooter
							McGinty as he celebrates Thanksgiving with the Pilgrims, rides
							through Lexington with Paul Revere, joins Lewis & Clark's Corps
							of Discovery, supports women's rights, and more. Includes
							background notes and teaching ideas..
						<p>
							<br>
