		...
		<div class="row details_row">
			...
			<div class="col-lg-6">
				<div class="details_image">
					<div class="details_image_large">
						<img src="/eretailweb/static/images/babydress.jsp" alt="">
			...
			<div class="col-lg-6">
				<div class="details_content">
					<div class="details_name">Amirtha Fashion Girl's Silk Cotton
						Lehanga Choli</div>
					<div class="details_discount">$777.00</div>
					<div class="details_price">$ 277.00</div>
					...
					<div class="details_text">
						...
						<p>MATERIAL: Mysore Silk Material</p>
						<p>STITCHED: Ready To Wear Dress</p>
						<p>Easy to Wear</p>
						<p>Sleeveless: Separate Sleeves Attached Inside</p>


						<P>
							
							<li>1 week Replacement Warranty on Manufacturing defects</li>
