...
<body bgcolor="#ffffee" leftmargin="10px" rightmargin="10px">
	...
	<form name=purchaseform action=/ecomm-eretail/getItemsFromCart.do onsubmit=getpurchasedproducts()>
	
	<div align="center">
		<h2>Display All Products</h2>
		
		
		<input type="hidden" id="myInput" name="purchaseditems" value="">
		
		
		<input type=submit value="Add Items To Cart" onclick="getpurchasedproducts()">
